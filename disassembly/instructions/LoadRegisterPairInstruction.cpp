...
LoadRegisterPairInstruction::LoadRegisterPairInstruction(uint32_t encoded) :
...
int16_t LoadRegisterPairInstruction::decode_immediate(bool is_wide, uint32_t encoded) {

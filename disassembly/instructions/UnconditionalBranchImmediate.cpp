...
InstructionDefs::UnconditionalBranchImmediate::UnconditionalBranchImmediate(uint32_t encoded) :
	is_with_link(encoded >> 31 & 1),
	immediate(UnconditionalBranchImmediate::decode_immediate(encoded)) {}

int32_t InstructionDefs::UnconditionalBranchImmediate::decode_immediate(uint32_t encoded) {
